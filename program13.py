...
Original file is located at
    https://colab.research.google.com/drive/1tX1WWqysg-rLiBlAof0eCB_gL2LeiiBc
"""
...
print(df.describe()) # Summary statistics of the dataset # Target variable distribution (if the dataset contains target classes, such as 'diagnosis')
